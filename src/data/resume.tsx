...
export const DATA = {
  ...
  summary: `After my graduation in Business Administration back in 2020, I developed a passion for digital marketing and website development. I began by building simple landing pages and quickly transitioned into a full-time role as a Junior Frontend Developer in 2021. Over the past ${
  ...
  navbar: [
    ...
    // {
    //   href: "https://github.com/raqib-rasheed/resumes/blob/main/Raqib___Rasheed.pdf",
    //   icon: FileArchive,
    //   label: "Resume",
    // },
  ],
  contact: {
    ...
    social: {
      ...
      // email: {
      //   name: "Send Email",
      //   url: "mailto:raqib.dev@gmail.com",
      //   icon: Icons.email,
      //   navbar: true,
      // },
    },
